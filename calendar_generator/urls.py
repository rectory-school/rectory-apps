...
urlpatterns = [
    ...
    path(
        'calendar/<int:calendar_id>/pdf/all-months/colors/<int:color_set_id>/layout/<int:layout_id>/', views.pdf_all_months,
        name='months-pdf'),
    path(
        'calendar/<int:calendar_id>/pdf/one-page/colors/<int:color_set_id>/layout/<int:layout_id>/', views.pdf_one_page,
        name='one-page-pdf'), ]
