...
urlpatterns = [
    ...
    path(
        'calendar-<int:calendar_id>/pdf/single-grid/style/<int:style_id>/layout/<int:layout_id>/from/<int:start_year>-<int:start_month>-<int:start_day>/to/<int:end_year>-<int:end_month>-<int:end_day>/',
